...
<div class="modal" id="form-modal">
    <form class="modal-content animate" method="post" action="dashboard.php?rend=trabajadores/trabajadores.php&acciones_trabajadores=contratar_resp">
        <div class="container-modal">
            ...
            <div class="inputExt">
                <input id="pass" class="inputInt" name=":PSW" placeholder="Contraseña" required type="password" value='<?php echo($form[":PSW"]) ?>'>
                </input>
               <label><input type=checkbox value="no" id=mostrarPass></input>Mostrar contraseña </label>
            </div>
            <label>
            ...
            <div class="botonExt">
              <input  class="botonInt" type=submit value=Contratar></input>
            </div>
        </div>
    </form>
</div>
