...
<div class="modal" id="form-modal">
    <form class="modal-content animate" method="post" action="dashboard.php?rend=obras/obras.php&acciones=nueva_obra">
        <div class="container-modal">
            ...
            <div class="inputExt">
                <input class="inputInt" name=":PRESUPUESTO" placeholder="Presupuesto" required="" type="number" value=<?php echo($form[":PRESUPUESTO"]); ?>></input>
            </div>
            <div class="inputExt">
                <input class="inputInt" name=":PROFORMA" placeholder="Proforma" required="" type="number" value=<?php echo($form[":PROFORMA"]); ?>> </input>
            </div>
            <div class="inputExt">
                <input class="inputInt" name=":COSTO" placeholder="Costo" required="" type="numver" value=<?php echo($form[":COSTO"]); ?>> </input>
            </div>
            <div class="inputExt">
